...
**This project is a work in progress so below is the roadmap/checklist to see how far along I am with the project.
...
### Columns table:
| Column | Keeping? | Reason|
|---|---|---|
| trans_date_trans_time | Yes |   |
